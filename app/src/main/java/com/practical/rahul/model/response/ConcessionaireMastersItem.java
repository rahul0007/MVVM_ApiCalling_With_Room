...
public class ConcessionaireMastersItem{

	@SerializedName("RefConcessionaireID")
	private Object refConcessionaireID;
	...
	public void setRefConcessionaireID(Object refConcessionaireID){
		this.refConcessionaireID = refConcessionaireID;
	}

	public Object getRefConcessionaireID(){
		return refConcessionaireID;
	}
	...
	@Override
 	public String toString(){
		return 
			"ConcessionaireMastersItem{" + 
			"refConcessionaireID = '" + refConcessionaireID + '\'' + 
			",emailID = '" + emailID + '\'' + 
			",companyID = '" + companyID + '\'' + 
